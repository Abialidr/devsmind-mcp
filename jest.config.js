...
module.exports = {
  ...
  // exercise one arm and istanbul still flags the other (concentrated in src/db/database.ts, plus
  // one in activity.ts). They are understood and accepted as the practical ceiling rather than
